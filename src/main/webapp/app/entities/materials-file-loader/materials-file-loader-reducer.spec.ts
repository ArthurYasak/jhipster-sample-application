...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './materials-file-loader.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIALSFILELOADER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIALSFILELOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIALSFILELOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIALSFILELOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIALSFILELOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIALSFILELOADER actions', async () => {
      const expectedActions = [
        {
