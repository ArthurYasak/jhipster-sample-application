...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './test-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTUSER actions', async () => {
      const expectedActions = [
        {
