...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './statistic-generator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATISTICGENERATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATISTICGENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATISTICGENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATISTICGENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATISTICGENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATISTICGENERATOR actions', async () => {
      const expectedActions = [
        {
