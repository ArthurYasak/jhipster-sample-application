...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './theme-file-creator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMEFILECREATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMEFILECREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMEFILECREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMEFILECREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMEFILECREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMEFILECREATOR actions', async () => {
      const expectedActions = [
        {
