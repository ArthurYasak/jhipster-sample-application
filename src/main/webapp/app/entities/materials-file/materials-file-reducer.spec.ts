...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIALSFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIALSFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIALSFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIALSFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIALSFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIALSFILE actions', async () => {
      const expectedActions = [
        {
