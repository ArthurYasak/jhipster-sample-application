...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCREATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCREATOR actions', async () => {
      const expectedActions = [
        {
