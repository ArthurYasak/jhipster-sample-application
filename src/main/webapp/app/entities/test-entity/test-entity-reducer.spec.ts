...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTENTITY actions', async () => {
      const expectedActions = [
        {
