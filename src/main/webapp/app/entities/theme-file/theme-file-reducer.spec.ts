...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMEFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEMEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEMEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEMEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEMEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEMEFILE actions', async () => {
      const expectedActions = [
        {
