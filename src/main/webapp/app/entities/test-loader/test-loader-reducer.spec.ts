...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTLOADER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTLOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTLOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTLOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTLOADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTLOADER actions', async () => {
      const expectedActions = [
        {
