...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tester.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTER actions', async () => {
      const expectedActions = [
        {
