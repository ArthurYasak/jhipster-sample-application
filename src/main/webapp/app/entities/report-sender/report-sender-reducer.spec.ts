...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTSENDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTSENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTSENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTSENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTSENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTSENDER actions', async () => {
      const expectedActions = [
        {
